...
constexpr std::array<Instruction, 0x100> instructions{
    ...
    Instruction{InstructionType::LD, InteractionType::AddressRegister_ImmediateByte,
                RegisterType::HL},
    // 0x37
    Instruction{InstructionType::SCF},
    // 0x38
    Instruction{InstructionType::JR, InteractionType::ImmediateByte, RegisterType::None,
    ...
    Instruction{InstructionType::XOR, InteractionType::Register_Register, RegisterType::A,
                RegisterType::A},
    // 0xB0
    Instruction{InstructionType::OR, InteractionType::Register_Register, RegisterType::A,
                RegisterType::B},
    // 0xB1
    Instruction{InstructionType::OR, InteractionType::Register_Register, RegisterType::A,
                RegisterType::C},
    ...
    Instruction{InstructionType::OR, InteractionType::Register_Register, RegisterType::A,
                RegisterType::L},
    // 0xB6
    Instruction{InstructionType::OR, InteractionType::Register_AddressRegister, RegisterType::A,
                RegisterType::HL},
    // 0xB7
    Instruction{InstructionType::OR, InteractionType::Register_Register, RegisterType::A,
                RegisterType::A},
