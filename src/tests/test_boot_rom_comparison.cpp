...
TEST_CASE("Compare boot sequence") {
    ...
    auto game_rom_path = std::filesystem::absolute("roms/stub-game.gb");
    // clang-format off
    /*
     * The stubbed game rom contains the following cartridge header:
     *
     * {0x00, 0xC3, 0x1, 0x50  entry point ,
